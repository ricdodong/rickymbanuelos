---
title: Ricky's Blog
description: Personal blog, repair, unlocks, bypass
intro: Welcome to my small and simple website!
style:
  hero_template: image
  template: full
  container: sm
...
hero:
  media:
    thumbnail: src/assets/ric.jpg
    video_preview: ""
    aspect: 1.777
    embed: youtube
    video_id: COIlLNfSLGM
    background_image: ""
    image_opacity: "0.1"
  background: pattern
  style:
  ...
  title: |
    Welcome to my small and **Simple** website!
  intro: >
    In this blog, you can see some of my life events, hobbies, repairs, and more.
  buttons:
    - icon_only: false
      label: Learn more
      href: "#more"
